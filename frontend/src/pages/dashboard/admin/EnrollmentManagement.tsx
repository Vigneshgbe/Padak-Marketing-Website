...
const EnrollmentManagement: React.FC = () => {
  ...
  const fetchRequests = async () => {
    try {
      ...
      const response = await fetch(`https://localhost:5000/api/admin/enrollment-requests`, {
        method: 'GET',
  ...
  const fetchEnrollments = async () => {
    try {
      ...
      const response = await fetch(`https://localhost:5000/api/admin/enrollments`, {
        method: 'GET',
        headers: getAuthHeaders(),
        credentials: 'include'
      });
  ...
  const handleApproveRequest = async (requestId: string) => {
    ...
    try {
      setSaving(true);
      const response = await fetch(`https://localhost:5000/api/admin/enrollment-requests/${requestId}/approve`, {
        method: 'PUT',
        headers: getAuthHeaders(),
        credentials: 'include'
      });
  ...
  const handleRejectRequest = async (requestId: string) => {
    ...
    try {
      setSaving(true);
      const response = await fetch(`https://localhost:5000/api/admin/enrollment-requests/${requestId}/reject`, {
        method: 'PUT',
        headers: getAuthHeaders(),
        credentials: 'include',
  ...
  const handleDeleteRequest = async (requestId: string) => {
    ...
    try {
      const response = await fetch(`https://localhost:5000/api/admin/enrollment-requests/${requestId}`, {
        method: 'DELETE',
        headers: getAuthHeaders(),
        credentials: 'include'
      });
  ...
  const handleSaveEnrollment = async () => {
    ...
    try {
      setSaving(true);
      const response = await fetch(`https://localhost:5000/api/admin/enrollments/${selectedEnrollment.id}`, {
        method: 'PUT',
        headers: getAuthHeaders(),
        credentials: 'include',
        body: JSON.stringify({
  ...
  const handleDeleteEnrollment = async (id: string) => {
    ...
    try {
      const response = await fetch(`https://localhost:5000/api/admin/enrollments/${id}`, {
        method: 'DELETE',
        headers: getAuthHeaders(),
        credentials: 'include'
      });
              ...
              <div className="col-span-2">
                ...
                {selectedRequest.payment_screenshot ? (
                  <div className="relative group">
                    <img 
                      src={`https://localhost:5000${selectedRequest.payment_screenshot}`} 
                      alt="Payment Proof"
                      ...
                      onClick={() => handleImageZoom(`https://localhost:5000${selectedRequest.payment_screenshot}`)}
                      onLoad={(e) => {
                        console.log('✅ Image loaded successfully:', `https://localhost:5000${selectedRequest.payment_screenshot}`);
                      }}
                      onError={(e) => {
                        console.error('❌ Image load error:', `https://localhost:5000${selectedRequest.payment_screenshot}`);
